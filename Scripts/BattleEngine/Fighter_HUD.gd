...
@onready var health_bar: TextureProgressBar = $MarginContainer/VBoxContainer/HealthHUD/HBoxContainer/HealthGauge
@onready var boost_bar: TextureProgressBar = $MarginContainer/VBoxContainer/BoostHUD/HBoxContainer/BoostGauge
@onready var battle_timer_progress: TextureProgressBar = $MarginContainer/VBoxContainer/BattleTimerHUD/HBoxContainer/BattleTimerGauge
